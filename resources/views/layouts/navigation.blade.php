<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('acquisitions.index')" :active="request()->routeIs('acquisitions.index')">
                        {{ __('Pengadaan') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('reports.transactions')" :active="request()->routeIs('reports.transactions') || request()->routeIs('reports.item_history')">
                        {{ __('Laporan') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('inventaris.index')" :active="request()->routeIs('inventaris.index')">
                {{ __('Inventaris') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('acquisitions.index')" :active="request()->routeIs('acquisitions.index')">
                {{ __('Pengadaan') }}
            </x-responsive-nav-link>
            ...
            <x-responsive-nav-link :href="route('reports.transactions')" :active="request()->routeIs('reports.transactions') || request()->routeIs('reports.item_history')">
                {{ __('Laporan') }}
            </x-responsive-nav-link>
        </div>
