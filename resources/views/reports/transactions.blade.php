...
@section('content')
    <div class="max-w-7xl mx-auto">
        <h1 class="text-3xl font-bold leading-tight text-gray-900 mb-8">Laporan Transaksi Inventaris</h1>

        <div class="bg-white shadow-md rounded-lg p-6 mb-8">
            <form action="{{ route('reports.transactions') }}" method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                ...
                <div>
                    ...
                    <select name="jenis" id="jenis" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        ...
                        <option value="penggunaan" {{ request('jenis') == 'penggunaan' ? 'selected' : '' }}>Penggunaan</option>
        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            @if ($transactions->isEmpty())
                <p class="text-gray-600">Tidak ada transaksi yang ditemukan untuk kriteria yang dipilih.</p>
            @else
